...
import com.tanjie.blog.config.KafkaSseConsumer;
import com.tanjie.blog.config.KafkaSseProducer;
...
public class BlogKafkaResource {
    ...
    public BlogKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
